    ...
    child: Material(
      ...
      child: InkWell(
        ...
        onTap: (){
          Navigator.push(
            context,
            PageTransition(child:  ProductDetails(id:productsModelProvider.id.toString(),), type: PageTransitionType.fade)
            );
        },
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Padding(padding: EdgeInsets.only(left: 5, right: 5, top: 8),
            child: Row(
            ...
            const SizedBox(height: 10,),
             Padding(
              ...
              child: Text(productsModelProvider.title.toString(),
